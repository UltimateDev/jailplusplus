...
public class BServer {
	...
	public void sendConsoleCommand(String cmd) {
		if (!mcServer.isStopped()) { //Deleted value here may cause problems
			Bukkit.getServer().dispatchCommand(mcServer.console, cmd);
		}
	}
	...
	//UltimateJail - this is never used anyway, so I guess it is okay.
