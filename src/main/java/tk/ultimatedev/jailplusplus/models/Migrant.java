...
public class Migrant {
    ...
    public enum DatabaseEngine {H2, MYSQL, FILE}
    ...
    public void migrate() {
        switch (engine) {
                ...
                try {
                    ...
                    */
                    ...
                    if (rs.next()) {
                        ...
                        st.executeUpdate("CREATE TABLE IF NOT EXISTS " + this.prefix + "jails" + "("
                                + "id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,"
                                + "name VARCHAR(32) NOT NULL UNIQUE," + "x1 INT NOT NULL," + "x2 INT NOT NULL,"
                                + "y1 INT NOT NULL," + "y2 INT NOT NULL," + "z1 INT NOT NULL,"
                                + "z2 INT NOT NULL," + "world VARCHAR(50)" + ")");
                    }
                    ...
                    */
                    ...
                    if (rs.next()) {
                        ...
                        st = conn.createStatement();
                        st.executeUpdate("CREATE TABLE IF NOT EXISTS " + this.prefix + "prisoners" + "("
                                + "id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,"
                                + "name VARCHAR(32) NOT NULL UNIQUE," + "cell INT NOT NULL," + "created BIGINT,"
                                + "expires BIGINT," + "reason VARCHAR(150)," + "jailer VARCHAR(20)," + "inv CLOB,"
                                + "x INT," + "y INT," + "z INT," + "world INT" + ")");
                    }
                    ...
                    */
                    ...
                    if (rs.next()) {
                        ...
                        st = conn.createStatement();
                        st.executeUpdate("CREATE TABLE IF NOT EXISTS " + this.prefix + "cells" + "("
                                + "id INT NOT NULL AUTO_INCREMENT PRIMARY KEY," + "jail INT NOT NULL,"
                                + "x1 INT NOT NULL," + "x2 INT NOT NULL," + "y1 INT NOT NULL,"
                                + "y2 INT NOT NULL," + "z1 INT NOT NULL," + "z2 INT NOT NULL," + ")");
                    }
                    ...
                    */
                    ...
                    if (rs.next()) {
                        ...
                        st.executeUpdate("CREATE TABLE IF NOT EXISTS " + this.prefix + "prisoners" + "("
                                + "id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,"
                                + "name VARCHAR(32) NOT NULL UNIQUE," + "cell INT NOT NULL," + "created BIGINT,"
                                + "sentence BIGINT," + "served BIGINT," + "reason VARCHAR(150),"
                                + "jailer VARCHAR(20)," + "inv CLOB," + "x INT," + "y INT," + "z INT,"
                                + "world INT" + ")");
                    }
                    ...
                    */
                    ...
                    if (rs.next()) {
                        ...
                        st.executeUpdate("CREATE TABLE IF NOT EXISTS " + this.prefix + "prisoners" + "("
                                + "id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,"
                                + "name VARCHAR(32) NOT NULL UNIQUE," + "cell INT NOT NULL," + "created BIGINT,"
                                + "expires BIGINT," + "reason VARCHAR(150)," + "jailer VARCHAR(20)," + "inv TEXT"
                                + ")");
                    }
            ...
            */
            ...
            default:
                Log.severe("You specified the database engine '"
                        + JailPlugin.getPlugin().getConfig().getString("database.driver")
                        + "', but the only supported databases are 'h2', 'mysql', and 'file'! Disabling plugin...");
                Bukkit.getPluginManager().disablePlugin(JailPlugin.getPlugin());
        ...
        switch (engine) {
            case H2:
                try {
                    ...
                    return DriverManager.getConnection("jdbc:h2:"
                            + JailPlugin.getPlugin().getDataFolder().getAbsolutePath()
                            + "/jpp_data", "jpp", "");
                } catch (ClassNotFoundException ex) {
                    exceptionHandler.logException(ex);
                    Log.severe(
                            "You specified the database engine 'h2', but I couldn't find the driver \"org.h2.Driver\"! Disabling plugin...");
                    Bukkit.getPluginManager().disablePlugin(JailPlugin.getPlugin());
            ...
            case MYSQL:
                try {
                    ...
                    exceptionHandler.logException(ex);
                    Log.severe(
                            "You specified the database engine 'mysql', but I couldn't find the driver \"com.mysql.jdbc.Driver\"! Disabling plugin...");
                    Bukkit.getPluginManager().disablePlugin(JailPlugin.getPlugin());
